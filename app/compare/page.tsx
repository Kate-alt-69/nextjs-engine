...
const CompareSchema = defineSchema({
  meta: { title: "Compare cities · Roavio", description: "Compare up to three nomad destinations side by side." },
  theme: roavioTheme,
  root: { type: "box", props: { bg: "var(--rv-paper)", minH: "100svh" }, children: [
    ...
    { type: "section", props: { contentMaxWidth: "1240px", px: "1rem", py: { xs: "3rem", md: "4.5rem" } }, children: [
      ...
      { type: "text", props: { content: "Swap any destination instantly. The best available value in each metric is highlighted without inventing missing source data.", color: "var(--rv-muted)", lineHeight: 1.65, maxW: "760px", mb: "1.5rem" } },
...
export default async function ComparePage() {
  ...
  const Page = createPage({ schema: CompareSchema, slots: { "compare-board": <CompareBoard catalog={catalog} /> }, compiler: { pageId: "roavio-compare", serverFirst: true } });
  return <Page />;
}
