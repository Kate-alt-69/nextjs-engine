...
const FavoritesSchema = defineSchema({
  meta: { title: "Favorites · Roavio", description: "Your saved nomad destinations." },
  theme: roavioTheme,
...
export default async function FavoritesPage() {
  ...
  const Page = createPage({ schema: FavoritesSchema, slots: { "favorites-board": <FavoritesBoard catalog={catalog} /> }, compiler: { pageId: "roavio-favorites", serverFirst: true } });
  return <Page />;
}
