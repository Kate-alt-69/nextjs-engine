...
function createCitiesSchema(locale: RoavioLocale) {
  ...
  return defineSchema({
    ...
    root: { type: "box", props: { bg: "var(--rv-paper)", minH: "100svh" }, children: [
      ...
      { type: "section", props: { className: "rv-explore-hero-section", contentMaxWidth: "1240px", px: "1rem", py: { xs: "3rem", md: "4.5rem" } }, children: [
        { type: "grid", props: { className: "rv-explore-hero-grid", columns: { xs: 1, md: "1.2fr .8fr" }, gap: "2rem", align: "end", mb: "1.4rem" }, children: [
          { type: "stack", props: { className: "rv-explore-hero-copy", direction: "vertical", gap: ".7rem" }, children: [
          ...
          { type: "box", props: { className: "rv-soft rv-explore-catalog-note", p: "1rem" }, children: [
