...
- Como ciudadano de la UE, la Tarjeta Sanitaria Europea (TSE/EHIC) te permite recibir asistencia médica necesaria en la red pública búlgara durante estancias temporales, cubriendo por ejemplo consultas con médicos concertados (con un pequeño copago) y hospitalización en centros públicos (también con una tasa diaria reducida).
- Sin embargo, la TSE está pensada para estancias puntuales, no para una residencia estable: en cuanto te registras como residente en Bulgaria, tu país de origen puede dar de baja la validez de la tarjeta para ese uso.
- El NHIF cubre consultas de atención primaria y especialista (con derivación), hospitalización, medicamentos subvencionados y atención materno-infantil.

## Barrios y coworkings

- Lozenets es el barrio favorito de muchos nómadas digitales: una zona residencial de calles arboladas cerca del centro, con buena oferta de cafeterías y espacios de trabajo, donde un piso de un dormitorio ronda entre 600 y 900 euros al mes.
- Oborishte, también céntrico, tiene un ambiente más artístico y cultural, con galerías y cafés, y alquileres algo más contenidos, entre 500 y 800 euros.
- Para quienes buscan opciones más económicas, Studentski Grad (la 'Ciudad Estudiantil') ofrece pisos desde 350-550 euros al mes en un ambiente joven y animado, mientras que Mladost, un distrito residencial algo más alejado pero bien conectado por metro, tiene alquileres similares, entre 350 y 600 euros.
- En cuanto a espacios de coworking, Betahaus Sofía es la red más consolidada, con cuatro sedes repartidas por la ciudad (Shipka, Slaveykov Square, ABC y Sofia Tower): ofrece bono de día por 20 euros, un plan 'Light' de escritorio compartido con acceso 24/5 por 85 euros al mes, puesto fijo ('Open Space') desde 200 euros al mes y oficina privada desde 250 euros al mes por persona (precios sin IVA).

## Internet y datos móviles

- Activa una eSIM antes de llegar a Sofía y ten datos desde el minuto uno, sin depender del wifi del aeropuerto ni buscar una SIM física.
